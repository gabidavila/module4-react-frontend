...
import { Card, Button } from 'semantic-ui-react'
 ...
 class ConferenceShow extends React.Component {
   ...
   render () {
     ...
     const talksContainer = {display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gridAutoRows: 'minmax(200px, auto)'}
    ...
    return (
      <div style={divStyle}>
        ...
        <div style={infoStyle}>
          ...
          {this.props.talks.length ? <Button style={{gridColumn: '2/3', backgroundColor: '#fff'}} className={'medium ui button'} onClick={() => this.setState({talksShown: true})}>See Talks</Button> : null}
        </div>
        <br/>
